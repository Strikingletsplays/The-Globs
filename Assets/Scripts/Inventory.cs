...
public class Inventory : MonoBehaviour
{
    ...
    public void addItem(GameObject obj)
    {
        if (IPanel1.transform.childCount == 0)
        {
            ...
            Item.transform.SetParent(IPanel1.transform);
        ...
        {
            Item = Instantiate(obj) as GameObject;
            Item.transform.SetParent(IPanel2.transform);
        ...
        {
            Item = Instantiate(obj) as GameObject;
            Item.transform.SetParent(IPanel3.transform);
        ...
        {
            Item = Instantiate(obj) as GameObject;
            Item.transform.SetParent(IPanel4.transform);
        ...
        {
            Item = Instantiate(obj) as GameObject;
            Item.transform.SetParent(IPanel5.transform);
